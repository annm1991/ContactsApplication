var app = angular.module('myApp.directives.googleSignIn', []);

app.directive('dirGoogleSignIn', function () {
     return {
         'restrict': 'A',
         ...
         'link': function (scope, ele, attrs) {
             ...
             '1049813291335-b9auvpjbig687s5aom9v31bpokj2uj7t.apps.googleusercontent.com');
             // build scope urls
